...
plotGroups{16}='relapsers_3months nonrelapsers_3months';
plotStims{16}='drugs-neutral';
plotStimStrs{16}='drugs-neutral';
...
% for f = 1:nFigs
    ...
    for g=1:numel(groups)
        ...
        if strcmp(groups{g},'controls')
            subjects=getCueSubjects('cue',0);
            subjects=subjects(1:36);
        elseif strcmp(groups{g},'patients')
            subjects=getCueSubjects('cue',1);
            subjects=subjects(1:20);
            subjects(21:24) = {'ja160416','as160317','tf151127','gm160909'};
        elseif strcmp(groups{g},'relapsers_3months')
            groups{g}='relapsers';
            subjects = {'si151120','as160317','tf151127','gm160909','wr151127','nb160221','ja151218','tj160529'};
        elseif strcmp(groups{g},'nonrelapsers_3months')
            groups{g}='nonrelapsers';
            subjects={'ag151024','wh160130','rv160413','cm160510','at160601','zm160627','jf160703','cg160715','rs160730','nc160905','jb161004','ja160416'};
