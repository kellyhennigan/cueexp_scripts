...
fp3 = fullfile(dataDir, 'qualtrics_data/Post_Scan_Survey_180319.csv');


% directory for saving out figures
outDir = fullfile(p.baseDir,'paper_figs_tables_stats','behavior','data');
...
relapse_3month_status = getCueData(subjects,'relapse_3months');
...
T=[table(subjects,group,relapse_3month_status) T]; 
