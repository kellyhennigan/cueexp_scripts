...
for subject in subjects:
	...
	######## AFNI NORMALIZATION:
	cmd = '@auto_tlrc -no_ss -base '+templateFilePath+' -suffix _afni -input t1_ns+orig'
	print cmd+'\n'
	if not justPrint:
		os.system(cmd)
	
	cmd = 'mv t1_ns_afni.Xat.1D t12tlrc_afni_xform; mv t1_ns_WarpDrive.log t12tlrc_afni.log; rm t1_ns.Xaff12.1D'
	print cmd+'\n'
	if not justPrint:
		os.system(cmd)
