...
# "nonr" stands for no nuisance regressors - this runs a glm that doesn't include the csf and wm nuisance regressors
...
out_dir = os.path.join(data_dir,'results_cue'+afniStr+'_nonr')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	#	'-stim_file 8 '+func_dir+'/cue_wm'+afniStr+'.1D -stim_base 8 -stim_label 8 wm ' 
		'-stim_file 7 regs/cue_cuec.1D -stim_label 7 cue '
		'-stim_file 8 regs/img_cuec.1D -stim_label 8 img '
		'-stim_file 9 regs/choice_cuec.1D -stim_label 9 choice ' 
		'-stim_file 10 regs/choicert_cuec.1D -stim_label 10 choice_rt ' 
		'-stim_file 11 regs/alcohol_trial_cuec.1D -stim_label 11 alcohol ' 
		'-stim_file 12 regs/drugs_trial_cuec.1D -stim_label 12 drugs ' 
		'-stim_file 13 regs/food_trial_cuec.1D -stim_label 13 food ' 
		'-stim_file 14 regs/neutral_trial_cuec.1D -stim_label 14 neutral ' 
