...
#subjects,gi = getsubs()
subjects = ['ag151024','al151016']
# subjects = ['aa151010','ag151024','dw151003','ie151020',
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-glt_label 4 preference -gltsym "SYM: -3*strong_dontwant -somewhat_dontwant +somewhat_want" '
