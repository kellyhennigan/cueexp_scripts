...
% Path to subjects
datapath = '/Users/kelly/cueexp/data';
...
%     matRoiFolder = fullfile(matProcDir,subjects{isubj},'ROIs');
    matRoiFolder = fullfile(datapath,subjects{isubj},'ROIs');
    ...
    cmd =sprintf('!/Applications/freesurfer/bin/mri_convert  --out_orientation RAS %s %s', fs_wm{1}, wmMaskFile); 
    disp(cmd)
%     eval(cmd);
