...
% FGs
fgPaths = {
    '../data/%s/fibers/mrtrix_fa/DAL_putamenL_dil2_autoclean.pdb',...
    '../data/%s/fibers/mrtrix_fa/DAL_caudateL_dil2_autoclean.pdb',...
    '../data/%s/fibers/mrtrix_fa/DAL_naccL_aboveAC_dil2_autoclean.pdb',...
    '../data/%s/fibers/mrtrix_fa/DAL_naccL_belowAC_dil2_autoclean.pdb',...
      '../data/%s/fibers/mrtrix_fa/DAR_putamenR_dil2_autoclean.pdb',...
    '../data/%s/fibers/mrtrix_fa/DAR_caudateR_dil2_autoclean.pdb',...
    '../data/%s/fibers/mrtrix_fa/DAR_naccR_aboveAC_dil2_autoclean.pdb',...
    '../data/%s/fibers/mrtrix_fa/DAR_naccR_belowAC_dil2_autoclean.pdb'};
% 
% fgColors = [   0.1294    0.4431    0.7098
