...
% ROI2 = {'caudateL','putamenL','PVTL'};
ROI2 = {'naccL','caudateL','putamenL','naccR','caudateR','putamenR','PVTL','PVTR'};


%% III. Set Parameters

nSamples     = 10000;    % Enter the number of pathway samples to generate.
...
batchFileName = fullfile(scrDir,[projectName, '_ctrGenBatch_', dateAndTime '.sh']);
