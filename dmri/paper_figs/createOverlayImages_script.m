...
fdFileStrs = {['DA_%s%s_dil2_autoclean_DAendpts_tlrc' smoothstr '_MEAN.nii.gz'];
    ['DA_%s%s_dil2_autoclean_DAendpts_tlrc' smoothstr '_MEAN.nii.gz'];
    ['DA_%s%s_dil2_autoclean_DAendpts_tlrc' smoothstr '_MEAN.nii.gz'];
    ['DA_%s%s_dil2_autoclean_DAendpts_tlrc' smoothstr '_MEAN.nii.gz']};
...
cols=getDTIFDColors(targets,fdStrs); % colors for fiber density maps
...
figPrefix = [targets{:} smoothstr];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% do it

% load fiber density files
fd = cellfun(@(x,y,z) niftiRead(fullfile(fdDir,sprintf(x,y,z))), fdFileStrs, targets,fdStrs);
