...
data_path <- '/Users/kelly/cueexp/data/relapse_data/relapse_data_180430.csv'
setwd('/Users/kelly/cueexp/figures/relapse_prediction')
...
df <- filter(df, Subject !='wh160130', Subject!= 'at160601', Subject!= 'lm160914', Subject!= 'jb161004',Subject!= 'se161021')
...
# 
# 
formula <- as.formula("relIn6Months ~ years_of_use")
res <- evalClassifier(df, formula, type='glm', split.method='loso')
print(res)
