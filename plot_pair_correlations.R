...
# load data 
d0 = read.csv('/Users/kelly/cueexp/data/relapse_data/relapse_data_180403.csv')
...
# names(dd)
# ```
dd=d0[,c("relIn6Mos","anxiety_diag","depression_diag","ptsd_diag")]
# 
# plots
# ```{r}
# #draws scatterplots, histograms, and shows correlations  (source found in the psych package)
png(filename = '/Users/kelly/cueexp/figures/relapse_prediction/clinical_diag_pairplots.png',
     units="in",
     width=5,
     height=5,
     res=300)
