...
out_dir = os.path.join(data_dir,'results_img_type_afni')  	# directory for out files 
#out_dir = os.path.join(data_dir,'results_img_type_ants')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 12 regs/img_alcoholca.1D -stim_label 12 alcohol ' 
		'-stim_file 13 regs/img_drugsca.1D -stim_label 13 drugs ' 
		'-stim_file 14 regs/img_foodca.1D -stim_label 14 food ' 
		'-stim_file 15 regs/img_neutralca.1D -stim_label 15 neutral ' 
