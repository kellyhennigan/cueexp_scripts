...
out_dir = os.path.join(data_dir,'results_cue'+afniStr+'_imgperiod')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 12 regs/alcohol_img_cuec.1D -stim_label 12 alcohol ' 
		'-stim_file 13 regs/drugs_img_cuec.1D -stim_label 13 drugs ' 
		'-stim_file 14 regs/food_img_cuec.1D -stim_label 14 food ' 
		'-stim_file 15 regs/neutral_img_cuec.1D -stim_label 15 neutral ' 
