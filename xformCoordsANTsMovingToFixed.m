function outCoords = xformCoordsANTsMovingToFixed(inCoords,xform_aff,xform_invWarp)
% -------------------------------------------------------------------------
...
% %%%% syntax for xform_str is based on documentation here: 
...
if ~isempty(xform_invWarp) % add inv warp xform, if given
   xform_str = [xform_str ' -t ' xform_invWarp];
end
