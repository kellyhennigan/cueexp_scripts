...
NIFTII = 'pp_cue_tlrc_afni_nuisancereg_errts.nii.gz'
BEHAVIORAL = 'drug_trial_onsets_REL.1D'
NIFTII_OUT_NAME = 'drugtrial_relapse.nii.gz'
TRS = [1, 2, 3, 4]
LAG = 2 # so really we're looking at trs 2+trs = [3, 4] of every trial (1-indexed)

#NIFTII = 'drugs.nii'
#BEHAVIORAL = 'relapse.1D'
#NIFTII_OUT_NAME = 'drugbeta_relapse.nii.gz'
#TRS = [1]
...
if __name__=="__main__":
    descriptor='relapse_oversampled'
    if not TEST:
        try:
