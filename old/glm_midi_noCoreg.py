...
func_files = 'pp_midi_noCoreg_tlrc.nii'

out_dir = os.path.join(data_dir,'results_midi_noCoreg')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 7 '+func_dir+'/midi_csf_noCoreg.1D -stim_base 7 -stim_label 7 csf ' 
		'-stim_file 8 '+func_dir+'/midi_wm_noCoreg.1D -stim_base 8 -stim_label 8 wm ' 
