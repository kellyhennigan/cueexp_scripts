...
Z_thresh='3.2905'   # desired voxelwise Z-score threshold (note this is an absolute value threshold, i.e., negative clusters are included
...
flist='Zdrug-neutral Zfood-neutral' # names of files to threshold, minus the file suffix
...
vols='1' 	# volume indices that contain Z-scores in the above files; note that afni uses zero indexing (i.e., first volume is 0, etc.)
#vols='0' 		
