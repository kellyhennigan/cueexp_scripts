...
out_dir = os.path.join(data_dir,'results_cue'+afniStr+'_reltest')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 13 regs/alcohol_firsthalf_trial_cuec.1D -stim_label 13 alcohol1 ' 
		'-stim_file 14 regs/drugs_firsthalf_trial_cuec.1D -stim_label 14 drugs1 ' 
		'-stim_file 15 regs/food_firsthalf_trial_cuec.1D -stim_label 15 food1 ' 
		'-stim_file 16 regs/neutral_firsthalf_trial_cuec.1D -stim_label 16 neutral1 ' 
		'-stim_file 17 regs/alcohol_secondhalf_trial_cuec.1D -stim_label 17 alcohol2 ' 
		'-stim_file 18 regs/drugs_secondhalf_trial_cuec.1D -stim_label 18 drugs2 ' 
		'-stim_file 19 regs/food_secondhalf_trial_cuec.1D -stim_label 19 food2 ' 
		'-stim_file 20 regs/neutral_secondhalf_trial_cuec.1D -stim_label 20 neutral2 ' 
