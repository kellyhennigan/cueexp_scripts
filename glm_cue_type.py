...
out_dir = os.path.join(data_dir,'results_type_waver_afni_cue')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 11 regs/cue_alcoholca.1D -stim_label 11 alcohol ' 
		'-stim_file 12 regs/cue_drugsca.1D -stim_label 12 drugs ' 
		'-stim_file 13 regs/cue_foodca.1D -stim_label 13 food ' 
		'-stim_file 14 regs/cue_neutralca.1D -stim_label 14 neutral ' 
